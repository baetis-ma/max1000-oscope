...
ENTITY uart IS   
   GENERIC(
      ...
      baud_rate   :   INTEGER      := 500_000;    --data link baud rate in bits/second
      --baud_rate   :   INTEGER      := 320_400;    --data link baud rate in bits/second    
   ...
   PORT(
      ...
      rx       :   IN    STD_LOGIC;                             --receive pin    generic ( d_width     :   INTEGER     := 8 );
...
ARCHITECTURE logic OF uart IS
   ...
   SIGNAL   tx_parity         :   STD_LOGIC_VECTOR(d_width DOWNTO 0);   --calculation    port (of transmit parity
